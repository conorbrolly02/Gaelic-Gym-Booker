 ...
 * 
 * Props:
 * - type: The alert type (determines color scheme)
 * - message: The message to display
 * - onClose: Optional callback when dismiss button is clicked
 */
...
export default function Alert({ type, message, onClose }: AlertProps) {
  return (
    <div
      className={`flex items-start gap-3 p-4 rounded-lg border ${alertStyles[type].container} 
                  animate-fade-in`}
      role="alert"
    >
      {/* Alert icon */}
